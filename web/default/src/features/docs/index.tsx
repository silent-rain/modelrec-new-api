...
const SIDEBAR_SECTIONS = [
  {
    ...
    items: [
      ...
      {
        id: "create-api-key",
        labelKey: "docs.sidebar.createApiKey",
        icon: FileCode2,
      },
    ...
    items: [
      {
        ...
        labelKey: "docs.sidebar.firstConversation",
  ...
  },
  {
    ...
    items: [
      {
        id: "api-reference",
        labelKey: "docs.sidebar.apiReference",
        icon: Code2,
      },
    ],
  },
  ...
  // },
  {
    ...
    items: [
      {
        id: "faq-section",
        labelKey: "docs.sidebar.faqSection",
        icon: HelpCircle,
      },
    ],
  },
...
export function DocsPage() {
  ...
  useEffect(() => {
    const ids = SIDEBAR_SECTIONS.flatMap((s) =>
      s.items.map((i) => i.id),
    ) as SectionId[];
                ...
                return (
                  <li key={item.id}>
                    ...
                    >
                      ...
                      <ChevronRight
                        className={cn(
                          "ml-auto size-3 opacity-0 transition-opacity",
      ...
      <AnimateInView animation="fade-up">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold tracking-tight">
            {t("docs.firstConversation.title")}
          </h2>
        </div>
        ...
        >
          ...
          >
            <span
              ...
              style={{
                backgroundColor: "rgba(117,136,231,0)",
                color: "#6179eb",
              }}
            >
              OpenAI 兼容
...
function ApiReferenceSection() {
        ...
        >
          ...
          >
            <span
              className="rounded-md px-3 py-1 text-xs font-medium"
              style={{
                backgroundColor: "rgba(5,191,6,0)",
                color: "rgb(0 188 114)",
              }}
            >
              cURL
            </span>
            <span className="text-xs" style={{ color: "#9aa5b8" }}>
              /v1/chat/completions
            </span>
          </div>
          <pre
            className="overflow-x-auto p-5 text-sm leading-relaxed"
            style={{ backgroundColor: "#1a1f2c", color: "#00bc72" }}
          >
            <code style={{ color: "#dce3ef" }}>
  ...
  -d '{"model":"gpt-4o","messages":[{"role":"user","content":"Hi"}]}'`}
        ...
        <h3 className="mb-3 mt-8 text-base font-semibold tracking-tight">
          {t("docs.apiRef.imageGeneration")}
        </h3>
        <div
          className="mt-0 overflow-hidden rounded-lg border shadow-sm"
          style={{
            backgroundColor: "#1a1f2c",
            borderColor: "rgba(255,255,255,0.08)",
          }}
        >
          ...
          >
            <code style={{ color: "#dce3ef" }}>
              {`curl -X POST "https://modelrec.net/v1/images/generations" \\
  -H "Authorization: Bearer sk-xxx" \\
  -H "Content-Type: application/json" \\
  -d '{
    "model": "image-01",
    "prompt": "一只可爱的小猫"
        ...
        >
          ...
          >
            <code style={{ color: "#dce3ef" }}>
              {`curl --request POST 'https://modelrec.net/v1/video/generations' \\
...
curl --request GET 'https://modelrec.net/v1/video/generations/task_pBKdi10NNqFCCcCl2e0Vs8wCxbIrtJZJ' \\
  --header 'Authorization: Bearer sk-xxx'`}
            </code>
          </pre>
        </div>
